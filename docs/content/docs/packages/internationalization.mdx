...
In this repo, `@repo/internationalization` owns shared locale plumbing and dictionary assets.
Keep route-specific copy and page composition in the consuming app or content system.
