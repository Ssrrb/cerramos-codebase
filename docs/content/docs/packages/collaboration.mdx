---
title: Collaboration
description: How collaboration infrastructure fits this repo.
type: reference
product: Collaboration
summary: How multiplayer collaboration works out of the box.
---

In this repo, `@repo/collaboration` is optional infrastructure inherited from the starter.
It should stay thin and must not become the source of truth for orders, payments, or merchant operations.
