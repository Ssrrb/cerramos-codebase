...
In this repo, `apps/docs` is the public or external docs surface.
Internal product architecture, repo rules, and package boundary guidance live under the root `docs/` workspace instead.
