...
In this repo, `@repo/rate-limit` owns the shared rate-limiting primitives and configuration.
Route ownership and feature-specific throttling policy still belong to the consuming app or route.
