...
In this repo, `@repo/storage` owns shared storage abstractions and object-key helpers.
Route ownership for media APIs and upload UX still belongs in the consuming app.
