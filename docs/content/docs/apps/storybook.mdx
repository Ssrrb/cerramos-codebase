...
In this repo, `apps/storybook` is the isolated UI workshop.
It should reflect shared component APIs from `@repo/design-system`, not become a second UI ownership layer.
