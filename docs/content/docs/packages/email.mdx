...
In this repo, `@repo/email` owns reusable email templates and email utilities.
Preview runtime concerns belong in `apps/email`, and feature-specific triggering belongs in the owning app or notification flow.
