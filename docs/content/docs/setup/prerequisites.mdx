...
- [Google Cloud](https://console.cloud.google.com/), for optional Google OAuth in [authentication](/docs/packages/authentication).
- [Neon](https://neon.tech), or another PostgreSQL provider, for the database used by [authentication](/docs/packages/authentication) and the rest of the app.
